...
export type DeserializedIdentityResponse = Omit<IdentityResponse, 'birthDate' | 'createdAt' | 'updatedAt' | 'incorporationDate'> & {
    birthDate?: string;
    createdAt: string;
    updatedAt: string;
    incorporationDate?: string;
};
export type DeserializedInvestmentTransaction = Omit<InvestmentTransaction, 'date' | 'tradeDate'> & {
    date: string;
    tradeDate: string;
};
export type DeserializedInvestment = Omit<Investment, 'date' | 'dueDate' | 'issueDate' | 'purchaseDate' | 'transactions'> & {
    date?: string;
    dueDate?: string;
    issueDate?: string;
    purchaseDate?: string;
...
export type DeserializedItemProductsStatusDetail = Omit<ItemProductsStatusDetail, 'accounts' | 'creditCards' | 'transactions' | 'investments' | 'identity' | 'paymentData'> & {
...
export type DeserializedItem = Omit<Item, 'createdAt' | 'updatedAt' | 'lastUpdatedAt' | 'parameter' | 'statusDetail' | 'userAction'> & {
